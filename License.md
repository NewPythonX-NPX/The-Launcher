...
Brand & Logo Protection: The "NewPythonX" name and the official logo (white_the_launcher.jpg) are the exclusive property of NewPythonX Studio. Using my brand name or logo in your own project without my written permission will result in an immediate Copyright Strike.

No Liability: This software is provided "as-is." NewPythonX Studio is not responsible for any crashes, bugs, or flying PCs that may occur while using this launcher.
